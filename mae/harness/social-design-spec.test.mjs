...
test("81. later-wave modules (carousel/platform/QA) do not exist yet", () => {
  // updated in Wave S-B (social-components.js) and Wave S-C (social-compositor.js): both are now
  // APPROVED deliverables, so they are no longer in this forbidden list.
